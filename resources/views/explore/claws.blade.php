...
<h2>Claws & Class </h2> 
<div id="shopnpc">
    <img src="{{asset('storage/kitt-folkbeautyani.gif')}}" width="500"  margin-left: 20px;">
    <div id="shopowner" class="bubble bubble-bottom-left">This is what the shopowner will say. This is what the shopowner will say. This is what the shopowner will say</div>
</div>
<div class="invetorydiv" style="width: 165px;">
   Cherry Pie
    ...
    border-color: #314D61; border-radius: 20px; height: 160px; width: 160px; margin-left: auto; margin-right: auto;">
        <div style="margin: 10px; position: absolute; background-color: #fff; border-radius: 5px; height: 20px; text-align: center; padding: 2px;">12</div>
   
        <img src="{{asset('storage/cherrypie.png')}}" width="150">
    </div>
    <span style="color: black; font-weight: bold;text-transform:capitalize;"> common</span><br>
    <img src="{{asset('storage/coin.png')}}" width="30px">1290 
</div>
