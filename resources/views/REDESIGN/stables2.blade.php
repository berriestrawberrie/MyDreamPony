...
@section('bodysection')
    <div class="stable ">
        ...
        <div class="topstable flex flex-col items-center sm:flex-row-reverse ">
            <div class="relative floating">
                <img class="island -scale-x-100 " src="{{asset('storage/images/island1.png')}}">
                <img class="house absolute scale-60 -top-5 left-0 -scale-x-60 sm:scale-100 sm:top-18 sm:left-32 sm:-scale-x-100" src="{{asset('storage/images/house.png')}}">
            </div>
            <div class="relative flex items-center flex-col mb-4 sm:flex-row-reverse">
                ...
                <a href="{{route('restable')}}"><img class="absolute hover:brightness-130 -top-20 left-0 scale-70 -scale-x-70 sm:relative sm:top-0 sm:scale-100 sm:-scale-x-100 " src="{{asset('storage/images/arrow.png')}}"></a>
            </div>
        </div>
